...
_HISTORICAL_KEYWORDS = [
    ...
    # --- Asian esoteric, ritual, and secret-society-adjacent ---
    "taoist", "taoism", "daoist", "daoism",
    "thangka", "tangka",
    "vajrayana", "vajra",
    "mandala",
    "tantric", "tantra",
    ...
    "boxer rebellion", "boxer_rebellion",
    "white lotus", "white_lotus",
    "esoteric",
    "ritual",
    "talisman",
    "fraternal", "brotherhood", "lodge",
    "tibetan",
    "wrathful",
    "minhwa", "mudang",
    "nianhua",
    "guan yu", "zhong kui",
    "eight immortals", "shichifukujin",
    "shingon", "vajrayana",
    "himalayan",
    ...
    "tsongkhapa",
    "dharmapala",
    "protector deity", "peaceful deity",
    "dorje",
    "ghanta",
    "phurba", "kila",
    "kapala",
